...
radio de cobertura (Figura~\ref{fig:cobertura}, véase Anexo);
...
Santa Catarina Yecahuizotl, Alcaldía Tláhuac: $DF=2.52$;
Figura~\ref{fig:desviacion}, véase Anexo); y
...
(Figura~\ref{fig:fuerza_capilar}, véase Anexo).
...
La Figura~\ref{fig:red} muestra la red unificada de la ZMVM expuesta por Apimetro
y la Figura~\ref{fig:dashboard} el panel de consulta REST (véase Anexo).
...
\begin{figure*}[h]
  \centering
  \includegraphics[width=\textwidth]{Dashboard_Apimetro_2026_Red_ZMVM}
  \caption{Red multimodal unificada de la ZMVM expuesta por Apimetro.
...
\begin{figure*}[h]
  \centering
  \includegraphics[width=\textwidth]{Dashboard_Apimetro_2026}
  \caption{Panel de consulta de Apimetro: interfaz REST con capas de red
           multimodal de la ZMVM en formato GeoJSON.  Fuente: elaboración propia.}
  \label{fig:dashboard}
\end{figure*}

\begin{figure*}[h]
  \centering
  \includegraphics[width=\textwidth]{Mapa_Cobertura_Mapa_Calor_vftmodel}
  \caption{Mapa de calor de cobertura espacial peatonal (isócrona 800~m)
           calculado por VFTModel sobre la red de la ZMVM.
           Fuente: elaboración propia.}
  \label{fig:cobertura}
\end{figure*}
...
\begin{figure*}[h]
  \centering
  \includegraphics[width=\textwidth]{Dashboard_Apimetro_2026_Factor_desviacion_grafica}
  \caption{Distribución del factor de desviación en 100~rutas interalcaldías
           de la ZMVM calculado por VFTModel.  Fuente: elaboración propia.}
  \label{fig:desviacion}
\end{figure*}

\begin{figure*}[h]
  \centering
  \includegraphics[width=\textwidth]{Dashboard_VFTModel_2026_Fuerza_capilar_grafica}
  \caption{Concentración de fuerza capilar ($FC_H$) en nodos del grafo de la ZMVM
           calculada por VFTModel.  Fuente: elaboración propia.}
  \label{fig:fuerza_capilar}
\end{figure*}
