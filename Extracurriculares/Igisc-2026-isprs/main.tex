...
procesamiento concurrente de flujos masivos de datos--- en combinación con una base
de datos relacional espacial PostgreSQL equipada con la extensión PostGIS.  Apimetro
ingiere los archivos GTFS oficiales de SEMOVI y los somete a un proceso de
normalización y estandarización.  Para resolver los vacíos de información del Estado
...
Mediante consultas SQL espaciales, Apimetro unifica ambas fuentes y genera un
modelo de datos coherente.  La segunda capa de Apimetro corresponde al motor
...
\begin{enumerate}[nosep, leftmargin=1.5em]
  ...
  \item \textbf{Cobertura periférica:}  Los municipios conurbados del Estado de
    México carecen en gran medida de archivos GTFS publicados.  Las rutas de
    sistemas como el Mexibús y los colectivos periféricos se obtienen íntegramente
    de OSM, donde mapeadores locales han documentado recorridos que las bases
    oficiales ignoran \citep{haklay2010good}.
  \item \textbf{Validación cruzada:}  Apimetro ejecuta un proceso de
    integración espacial que compara las geometrías GTFS con las de OSM
...
de ajuste geométrico intermodal con umbral de $\leq 50$~m resuelve las
interconexiones entre sistemas.  De los 11~sistemas integrados, el 88\% corresponde
...
\citep{galigaribaldi2026vftmodel}, un motor analítico en Python que consume
...
\begin{enumerate}[nosep, leftmargin=1.5em]
  \item \textbf{Cobertura espacial ($C$):} isócronas peatonales de 800~m alrededor
    ...
    11.75\% de cobertura, la peor alcaldía de la Ciudad de México.
