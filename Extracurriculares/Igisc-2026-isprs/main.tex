...
radio de cobertura; (2)~\textbf{factor de desviación ($DF$)}, cociente entre la
...
Santa Catarina Yecahuizotl, Alcaldía Tláhuac: $DF=2.52$); y
...
$FC_H=130$ en la zona de Hospitales Sur.
...
transporte y $XX$~rutas, todo en un volumen de 38~MB de datos procesados.  Estos resultados ilustran cómo Apimetro facilita el acceso a datos de red
normalizados para cualquier usuario, sin necesidad de programar, limpiar archivos
de texto ni reparar trazos geométricos rotos.
