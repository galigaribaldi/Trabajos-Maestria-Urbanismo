...
\begin{frame}{Objetivos de la Presentación}
  \begin{block}{Objetivo General del Taller}
    ...
    sobre transportes anillares bajo 3 ejes: \textbf{Social, Económico y Geográfico} en el entorno de una
    Megalopolis como lo es la Ciudad de México y su área Metropolitana.
  \end{block}
  \vspace{0.4cm}
  \begin{columns}[T]
