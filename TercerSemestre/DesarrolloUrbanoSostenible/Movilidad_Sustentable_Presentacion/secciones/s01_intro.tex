...
\begin{frame}{El Cambio de Paradigma: Del Transporte a la Movilidad}
    \begin{itemize}
        ...
        \item \textbf{Paradigma Contemporáneo (Movilidad):} Enfoque antropocéntrico basado en la \textbf{accesibilidad de las personas} y su interacción con el entorno urbano \cite{RamirezPacheco2025}.
    \end{itemize}
