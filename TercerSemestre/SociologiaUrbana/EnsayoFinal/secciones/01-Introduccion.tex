...
El urbanismo en México no puede analizarse sin un estudio profundo por su historia y evolución a lo largo del siglo XX 
y XXI. Desde la revolución Mexicana acontecida desde 1910 y terminando oficialmente con la promulgación de la constitución 
política de los Estados Unidos Mexicanos de 1917 acontecida en el mismo año. Sin embargo, México como país no despegaría hasta 
la época conocida como el \termino{Cardenismo}, el cual tuvo como figura principal al general Lázaro Cárdenas del Río. Quién 
...
económica en México. A esta etapa se le puede llamara \termino{La dictadura Perfecta} \cite{vargasllosa_dictadura}. Sin embargo, la sociedad y su manera 
...
del México Moderno y Contemporáneo. En este ensayo se explorarán 6 puntos particulares, pero que se resumen fácilmente a través de 3 ejes 
...
sinergia y convivencia que tienen su habitantes dependiendo de su rango de edad; \termino{Generación Silenciosa (1928-1945)}, 
...
Entender que esto no es un problema aislado y que no existe un solo culpable (ni generacional, ni político, ni económico) nos da un mejor panorama de como 
diagnosticarlo, aunque la cura aún este en proceso de creación. 
...
analisis \textit{Apimetro \cite{galigaribaldi_apimetro}} y \textit{Modelo de la Higuera Evanescente o VFTModel \cite{galigaribaldi_vftmodel}}. Centrado en 4 puntos:

\begin{itemize}
    \item Analizar la disputa y correlación que tienen las Ciencias Sociales como la sociología y filosofía con las Ciencias Exactas o Matemáticas como las Matemáticas y la Computación. 
    ...
    \item Analizar como la ciudad y las necesidades económicas han orillado a sus habitantes a un \termino{Estándar} de personalidad.
