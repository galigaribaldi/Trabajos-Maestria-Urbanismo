...
\begin{itemize}
    ...
    acción individual a la estructura coercitiva de la totalidad de la red \cite{durkheim2001reglas}.
...
dentro de un área que el urbanismo denomina \termino{Zonas metropolitanas}, áreas compuertas por dos o más 
entidades que sobrepasan un tipo de gobierno, en su mayoría pueden ser estatal y cuando crecen más, pueden llegar 
a ser federal. El caso más claro lo tenemos en la zona centra con la conocida \zmvm. Aunque no es la única, se tienen
...
\\
Si es así \textbf{¿Por que se dice que vivimos un proceso de estandarización/despersonalizacion en la personalidad?}: 
La respuesta es más dificil de responder con datos cuantitativos, ya que la misma definición de personalidad a nivel 
psicológico puede definirse como las conductas o acciones que tenemos con las personas que nos rodean y al constructo 
que definen y moldean el comportamiento con nuestro semejantes dentro de un grupo conocido como sociedad. Esto deja mal 
parado a este analisis, ya que sería dificil cuantificar un espectro con multiples sombras y luces y aún así, podemos 
irnos con la vertiente de otros textos. Según \cite{wirth_urbanismo} en a sección \termino{El urbanismo como modo de vida}, 
...
que dichos requerimientos no obedecen a ningun plan establecido para moldear el comportamiento de las masas a una planeación 
...
a partir de creencias, modas y bienes de consumo provenientes de las redes sociales más inlfluyentes del momento. Esto no es algo 
nuevo ni tampoco un \termino{Descubrimiento}, el ser humano siempre tiende a seguir un grupo social dominnate por el mero 
instinto de superviviencia social inherente a nuestra evolución. Sin embargo, esta réplica de ideas ya no obedece a figuras 
...
manos, el poder mediático o simplemente quién goce de un momento de fama en el momento correcto. Este fenómeno fue estudiado por 
De acuerdo con Bauman, la dinámica del consumismo moderno altera nuestra percepción del bienestar, lo que se 
retrata en la siguiente frase:
\citaclave{
...
sería un error cualitativo. El país siempre se ha pintado como \termino{De raíces orginarias} o con \termino{Cultura Ancestral}, 
...
integrantes de la comunidad. En la obra \textit{Índigenas de la nación} se describe el orígen ancestral de la alacladía de Milpa 
Alta, el cual no constituyó nunca un pueblo unido desde sus raíces prehispánicas, si no a una alianza surgida antes de la 
...
\termino{Oztotepec} si no por pobladores del centro de de \termino{Atocpan, Malacachtepec} y \termino{Tlacotenco}, haciendo que la 
...
una prorroga para medir los parajes, pero esta solución quedó en el aire, ninguno de los dos bandos quedó conforme y el caso se 
volvió a reabrir en el último gobierno de Santa Ana (1855). En él, el nuevo gobierno manda emisarios y con ello, nace el mito 
de \termino{La vírgen de la Asunción}, en el que se cuenta que un hombre al visitar el paraje del ojo de agua \termino{Tulmiac}, 
fue visitado por una vírgen de aspecto blanco y celestial que le mencionó que el ojo de agua sería un regalo para la unión, 
...
retrato en el municipio de Chalco de Díaz de Covarrubias, donde llegaría impregada de \termino{Sabiduría y amor}. Con ello, 
...
incredulidad de los más férreos fue notoria en los primero procesos, las dudas se disiparon cuando la \termino{Vírgen de la Asunción}, 
llegí al centro de la recién formada Delegación de Milpa Alta. El mito prevalece hasta la fecha y los habitantes lo recuerdan 
...
a \termino{Xicomulco, Cuauhtenco, Oztotepec}; actual \termino{San Bartolomé Xicomulco, San Salvador Cuauhtenco y Sab Pablo Oztotepec} 
respectivamente. Siendo que estos no son considerados en la toma de decisiones a nivel comunal; pues los doce comuneros de la región de 
Milpa Alta les basta con tener una mayoría de concensos (los nueve pueblos originarios). \\
\textbf{¿De que nos sirve este ejemplo?}, si lo dejamos como una historia meramente anecdótica, pierde todo su valor en este ensayo. 
En \textbf{El laberinto de la Soledad}, Octavio paz describe como la sociedad mexicana es una amalgama de culturas que no acaban de 
...
ferderal y el de la Ciudad de México haya cesado ya hace unos años por el entendimiento del mal llamado \termino{Gobierno de los Pueblos}, 
...
más \termino{Citadina}, \termino{Gilles Deleuze} define con ayuda de las obras de \termino{Focault} que estos \termino{Sismas} o 
sucesos de cambio se les puede llamar \termino{dispositivos}, los cuales pueden ser culturales, ideológicos, políticos, económicos y, 
más recientemente tecnológicos. A pesar de este esto, notamos un cierto \termino{Estándar} en toda la cultura mexicana alejada u 
\termino{originaria}; festividades fuertemente arraigadas a símbolos de la fé católica que combinan elementos de la cultura prehispánica, 
...
de la \termino{generación Milenial y Generación Z}, pero poco a poco va cayendo en una despersonalizacion sistémica. A la mayor parte 
de las generaciones actuales no les interesa saber el significado cultural de su región, su orígen o sus figuras católica-religiosas, 
...
sitémica de bebidas alcoholicas preparadas o de \termino{Descorche} durante todo lo que dure la fiesta y una insesante banda de música 
\termino{Regional Mexicano}, interpretando temas de moda que se han popularizado en los úiltimos veinte años a causa de una cultura basada 
...
ciertas conductas pueden entenderse como un todo y su influencia en la sociedad encamina hacía un fín común. En este caso, donde la 
cultura de la apariencia, el consumo y la \termino{líquidez} o inmediatez del momento, revela que no se tiene un concenso 
esperanzador de las nuevas generaciones (parte de la \termino{Generación Milenail} y \termino{Generación Z}) hacia su futuro, 
...
En \cite{foucault2002vigilar}, Focault explora la idea de un \termino{Dispositivo Panóptico}, aquel que explora el control de las masas 
...
basa en un modelo de cárcel construida por el filósfo Jeremy Bentham en 1791 e implementada en otros países, donde la población o 
\termino{Carcelarios} son constantemente vigilidas al punto de que si cometen una falta al órden establecido, serán castigados 
