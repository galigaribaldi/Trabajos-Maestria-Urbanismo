...
\begin{itemize}
    ...
    \item \textbf{Social:} La movilidad no debe verse como un castigo sistémico que te recuerda que \termino{eres pobre}. 
            Países del primer mundo como la ciudad de Helsinki, Japón y el tren de alta velocidad en España revelan un cambio 
    ...
    \item \textbf{Cultural:} Muchos son los autores que describen a México como un país rico en cultura, tradiciones y calidez humana. Esto es 
            totalmente cierto. Pero como lo han evidenciado figuras de distinta naturaleza ---desde el análisis intelectual de \textbf{Octavio Paz} hasta la gestión política de sexenios como el de \textbf{Gustavo Díaz Ordaz}---, uno de los mayores problemas de México es el México mismo. Su población esta concentrada en sobrevivir 
            ...
            de una obra pública (como lo es el mismo Metro de la Ciudad de México), se cometen actos de vandalismo por parte de la misma población. 
    ...
    \item \textbf{Tecnológico:} En el año que se escribe este ensayo (2026), se tiene un mayor acceso al hardware (elementos físicos de una computadora) y 
            ...
            con la adopción de \termino{Tecnologías innovadoras} en vez de tecnologías útiles. El ejemplo más claro es los tramites administrativos, tener digitalizados todos 
